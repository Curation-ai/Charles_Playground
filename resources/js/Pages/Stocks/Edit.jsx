...
export default function StockEdit({ stock }) {
    const { data, setData, put, processing, errors } = useForm({
        ticker: stock.ticker,
        name: stock.name,
        date_mentioned: stock.date_mentioned,
    ...
    return (
        <Layout>
            <Head title={`Edit ${stock.ticker}`} />

            <div className="py-12">
                <div className="max-w-2xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <h1 className="text-3xl font-bold text-gray-800 mb-6">Edit {stock.ticker}</h1>
